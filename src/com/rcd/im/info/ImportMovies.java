...
public class ImportMovies {
    ...
    public static void main(String[] args) {
        try {
            LineNumberReader lineReader = new LineNumberReader(new FileReader("movielens/movies.dat"));
            String line = "";
    ...
    private static void persist(List<Movie> movies) {
        ...
        String sql = "insert into " + TABLE_NAME + " ( " + ID_COLUMN + ", " + NAME_COLUMN + ", "
                + PUBLISHED_YEAR_COLUMN + ", " + TYPE_COLUMN + ") values (?, ?, ?, ?)";
        try {
    ...
    private static Movie fillMovie(String line) {
        ...
        movie.setYear(mo[1].substring(mo[1].lastIndexOf("(") + 1, mo[1].lastIndexOf(")")));
